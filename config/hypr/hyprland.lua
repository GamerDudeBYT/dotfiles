...
local droidcam            = "droidcam"
local notification_center = "swaync-client -t -fw"
...
hl.env("QT_QPA_PLATOFRMTHEME", "qt5ct")
...
-- -- This is a good shutdown command
...
hl.bind(mainMod .. " + ALT + W", hl.dsp.exec_cmd("whatsapp-electron"))
